  ...
  <div class="container">
    ...
    <div class="row">
      <div class="col-12 justify-content-center d-flex pt-3">
        <div id="SignupWeb" class="flex-item border">
          <h2 class="pt-4 pl-4">Create Account</h2>
          <form @submit="SignupWeb" class="pt-4 pl-4 pr-4">
  ...
  methods: {
    async SignupWeb(e) {
      ...
      if (this.password === this.confirmPassword) {
        ...
        await axios
          .post(`${this.baseURL}user/SignupWeb`, user)
          .then(() => {
            this.$router.replace("/");
            swal({
              text: "User SignupWeb successful, please login",
              icon: "success",
            });
          })
